# # evaluate_agents.py
# # Run from project root: python evaluate_agents.py
# #
# # Evaluates the agent routing decision on the full 1409-customer test set.
# # No LLM, no RAG, no MCP — only the XGBoost predict_proba call from Agent 1.
# # Produces a metrics table comparable to run_pipeline.py output.
